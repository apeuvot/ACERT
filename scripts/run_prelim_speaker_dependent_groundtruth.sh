#!/bin/bash
# Preliminary design experiment: context restricted to the target speaker, using the
# ground-truth _F/_M tag of the IEMOCAP filenames.
set -e
...
SAVING_PATH="./results/${DATASET_NAME}/${MODEL_SHORT_NAME}_t=${CONTEXT_DURATION}_spkdep_gt__${DATETIME}"
